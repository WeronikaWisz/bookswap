...
public class FilterHints implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(titles, that.titles) && Objects.equals(authors, that.authors)
                && Objects.equals(publishers, that.publishers) && Objects.equals(categories, that.categories)
                && Objects.equals(localization, that.localization) && Objects.equals(owners, that.owners);
    }

    @Override
    public int hashCode() {
        return Objects.hash(titles, authors, publishers, categories, localization, owners);
    }
}
